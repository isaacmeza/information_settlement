...
********************************************************************************
esttab using ".\paper\Tables\reg_results\Reg1_all_log.csv", se star(* 0.1 ** 0.05 *** 0.01) b(a2) ///
...
********************************************************************************
esttab using ".\paper\Tables\reg_results\Reg1_con_log.csv", se star(* 0.1 ** 0.05 *** 0.01) b(a2) ///
	scalars("Erre R-squared" "DepVarMean DepVarMean" "dummygiro DummyGiro") replace 
...
********************************************************************************
esttab using ".\paper\Tables\reg_results\Reg1_lau_log.csv", se star(* 0.1 ** 0.05 *** 0.01) b(a2)  ///
	scalars("Erre R-squared" "DepVarMean DepVarMean" "dummygiro DummyGiro" ) replace 
