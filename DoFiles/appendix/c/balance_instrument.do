...
merge m:1 junta exp anio using ".\DB\followUps2020.dta", gen(merchados) keep(1 3)
...
*Save results	
esttab using "./paper/Tables/reg_results/balance_instrument.csv", se r2 ${star} b(a3) ///
