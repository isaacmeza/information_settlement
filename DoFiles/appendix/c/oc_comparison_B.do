...
graph export "./paper/Figures/diff_amt_e.pdf", replace 
...
graph export "./paper/Figures/diff_prob_e.pdf", replace 
...
twoway (hist diff_amount if diff_amount<160 & diff_amount>=-50 , w(10) percent) ///
	...
	title("Amount") xtitle("Survey - Calculator in thousand pesos") ///
	legend(off) name(amount, replace)
graph export "./paper/Figures/diff_amt_el.pdf", replace 
...
twoway (hist diff_prob, w(10) percent) ///
	...
	title("Probability") xtitle("Survey -  Calculator in % points") ///
	legend(off) name(prob, replace)
graph export "./paper/Figures/diff_prob_el.pdf", replace 
...
twoway (hist diff_amount if diff_amount<160 & diff_amount>=-50 , w(10) percent) ///
	...
	title("Amount") xtitle("Survey - Calculator in thousand pesos") ///
	legend(off) name(amount, replace)
graph export "./paper/Figures/diff_amt_fl.pdf", replace 
...
twoway (hist diff_prob, w(10) percent) ///
	...
	title("Probability") xtitle("Survey -  Calculator in % points") ///
	legend(off) name(prob, replace)
graph export "./paper/Figures/diff_prob_fl.pdf", replace 
