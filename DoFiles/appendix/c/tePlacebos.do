...
*******************
	...
	*************************
	esttab using "./paper/Tables/reg_results/te_placebo.csv", se star(* 0.1 ** 0.05 *** 0.01) b(a2) ///
	scalars("Erre R-squared" "DepVarMean DepVarMean" "IntMean InteractionVarMean" "Pvalueplacebo Pvalueplacebo" ) replace 
