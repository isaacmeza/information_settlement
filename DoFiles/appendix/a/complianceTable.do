...
***
use "./Raw/Append Encuesta de Salida", clear
...
keep if renglon==1
putexcel set "./paper/Tables/Compliance.xlsx", sheet("Compliance") modify
...
merge 1:1 folio fecha using "./Raw/Append Encuesta Inicial Demandado.dta", keep(1 3)
gen ans_D=(_merge==3)
drop _merge

merge 1:1 folio fecha using "./Raw/Append Encuesta Inicial Representante Actor.dta", keep(1 3)
gen ans_RA=(_merge==3)
drop _merge

merge 1:1 folio fecha using "./Raw/Append Encuesta Inicial Representante Demandado.dta", keep(1 3)
gen ans_RD=(_merge==3)
drop _merge
