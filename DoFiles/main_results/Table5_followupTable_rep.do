...
merge 1:1 junta exp anio using ".\DB\followUps2020.dta",  keep(1 3) nogen
...
putexcel set ".\paper\Tables\Table5_December2018Followup.xlsx", mod sheet("Table5_December2018Followup")
...
forvalues  i = 1/2{
putexcel set ".\paper\Tables\Table5_December2018Followupp`i'.xlsx", mod
