...
#delimit cr
graph export "./paper/Figures/pdf_valordecaso.pdf", replace 
...
twoway (line fc_cdf_1 fc if fc<=`r(p95)', color(black) lpattern(solid) ///
	...
	ytitle("") xtitle("Pesos") ///
	legend(order(1 "Treatment" 2 "Control" 3 "T-C") rows(1) pos(6)) xtitle("Value of the case") graphregion(color(white)) 

graph export "./paper/Figures/cdf_valordecaso.pdf", replace 