...
cd "D:\Dropbox\Dropbox\Documentos_\MCLC\Pilot 1\information_sett\ReplicationFinal"
...
* A4: Balance table
do "DoFiles\appendix\balance_corrected.do" //Me faltan observaciones del P1. Supongo que vienen de las neuvas iniciales? Está raro
