...
*CF
*5) Probit - CF
ritest altT _b[altT] _b[c.altT#c.p_actor], samplingsourcefile("./_aux/samplePooled2.dta") samplingmatchvar(junta exp anio) reps(10000): reg seconcilio c.altT##c.p_actor `controls' gen_resid_pr8 if phase==1, robust  cluster(fecha)
matrix pvalues=r(p)
