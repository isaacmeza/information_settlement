...
ritest altT _b[altT] _b[c.altT#c.p_actor], samplingsourcefile("./_aux/samplePooled2.dta") samplingmatchvar(junta exp anio) reps(10000): reg npv_wz c.altT##c.p_actor  `controls'  if !missing(asinhNPVImputed), robust  cluster(fecha)
	matrix pvalues=r(p)
...
*2) IHS NPV (0s)
ritest altT _b[altT] _b[c.altT#c.p_actor], samplingsourcefile("./_aux/samplePooled2.dta") samplingmatchvar(junta exp anio) reps(10000): reg asinhNPV c.altT##c.p_actor  `controls'  if !missing(asinhNPVImputed), robust  cluster(fecha)
	matrix pvalues=r(p)
	local pvalNoInteract = pvalues[1,1]
	local pvalInteract = pvalues[1,2]
...
ritest altT _b[altT] _b[c.altT#c.p_actor], samplingsourcefile("./_aux/samplePooled2.dta") samplingmatchvar(junta exp anio) reps(10000): reg npvImputed_wz c.altT##c.p_actor  `controls'  if !missing(asinhNPVImputed), robust  cluster(fecha)
	matrix pvalues=r(p)
	local pvalNoInteract = pvalues[1,1]
	local pvalInteract = pvalues[1,2]
...
ritest altT _b[altT] _b[c.altT#c.p_actor], samplingsourcefile("./_aux/samplePooled2.dta") samplingmatchvar(junta exp anio) reps(10000): reg asinhNPVImputed c.altT##c.p_actor  `controls'  if !missing(asinhNPVImputed), robust  cluster(fecha)
	matrix pvalues=r(p)
	local pvalNoInteract = pvalues[1,1]
	local pvalInteract = pvalues[1,2]
...
ritest altT _b[altT] _b[c.altT#c.p_actor], samplingsourcefile("./_aux/samplePooled2.dta") samplingmatchvar(junta exp anio) reps(10000): reg asinhNPVImputed_robust c.altT##c.p_actor  `controls'  if !missing(asinhNPVImputed), robust  cluster(fecha)
	matrix pvalues=r(p)
	local pvalNoInteract = pvalues[1,1]
	local pvalInteract = pvalues[1,2]
...
ritest altT _b[altT], samplingsourcefile("./_aux/samplePooled2.dta") samplingmatchvar(junta exp anio) reps(10000): reg asinhNPV altT `controls'  if !missing(asinhNPVImputed), robust  cluster(fecha)
	matrix pvalues=r(p)
	local pvalNoInteract = pvalues[1,1]
