...
merge 1:1 junta exp anio using ".\p1_w_p3\out\inicialesP1Faltantes_wod.dta", keep(1 3) keepusing(abogado_pubN tipodeabogado_M fechadecaptura2 numActoresN ) gen(_mNuevasIniciales) 
