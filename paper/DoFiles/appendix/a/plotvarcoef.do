use "C:\Users\isaac\Dropbox\Apps\ShareLaTeX\Information Settlement_2020\paper\DB\varimppr.dta", clear
...
graph export "C:\Users\isaac\Dropbox\Apps\ShareLaTeX\Information Settlement_2020\paper\Figuras\coef_`model'.pdf", replace


twoway (rcap  lo hi ft ,   horizontal color(navy%90) lw( medthick )) ///
			(scatter  ft beta ,  ylabel(1(1)20, valuelabel angle(0)) msymbol(O) color(navy%90)) ///
