...
#AIzaSyCzduBLNcJAdkcEGvs02oVQDBybi2DKS9s
key<-"AIzaSyCRk3iPtvT7RVDSfkRJjpYsEdJul96Sr7U"
register_google(key = key)

setwd('C:/Users/xps-seira/Dropbox/Apps/ShareLaTeX/information_settlement/Paper/RScripts')
