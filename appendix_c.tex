...
%     \label{table_fs_cf}
%     \begin{center}
%     \scriptsize{\input{paper/Tables/presence_time_hearing.tex}}
%     \end{center}
%      \scriptsize
...
\begin{table}[!ht]
    ...
    \begin{center}
    \scriptsize{\input{paper/Tables/balance_instrument}}
    \end{center}
    \scriptsize
...
\begin{table}[!ht]
    ...
    \begin{center}
    \scriptsize{\input{paper/Tables/te_heterogeneity.tex}}
    \end{center}
         \scriptsize
...
%     \begin{center}
%         \includegraphics[width=0.9\textwidth]{paper/Figuras/Diagram_Case_Origination_.png}
%         \end{center}
